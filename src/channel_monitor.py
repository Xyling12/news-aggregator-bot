...
class ChannelMonitor:
    ...
    def _is_entertainment_post(text: str) -> bool:
        ...
        phrases = [
            ...
            # «ночной чат»-интерактивы источников дублируют нашу рубрику evening_fun
            # (и тащат картинки с чужим вотермарком, например «СМИ#1»)
            "ночной чат", "ночном чате", "ночного чата",
            "предлагаем вспомнить", "напишите в комментариях",
            "какой сегодня праздник", "гороскоп на",
            "найди отличия", "загадка:",
            # «Сегодня отмечается всемирный день …» — мусорные инфоповоды,
            # часто с неверными датами; свои праздники берём из HOLIDAYS
