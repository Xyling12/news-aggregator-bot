...
Важные даты, имена, цифры — пиши с эмодзи-акцентом (например: «в 1760 году 🗓», «целых 3 000 человек 🔢»).
...
Факты РЕАЛЬНЫЕ. Ключевые цифры выдели эмодзи (→ «аж 42 года!», «целых 150 метров...»).
